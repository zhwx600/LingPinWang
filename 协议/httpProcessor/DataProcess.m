...
{
    NSString* filepath1 = [[DataProcess getImageFilePath] stringByAppendingPathComponent:SQL_FILE_NAME];
    NSString* filepath2 = [[DataProcess getMainPath] stringByAppendingPathComponent:SQL_FILE_NAME];
